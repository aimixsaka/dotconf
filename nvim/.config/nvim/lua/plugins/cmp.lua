...
return {"hrsh7th/nvim-cmp", config = _1_, dependencies = {"hrsh7th/cmp-nvim-lsp", "hrsh7th/cmp-buffer", "hrsh7th/cmp-path", "hrsh7th/cmp-cmdline", "hrsh7th/cmp-nvim-lsp", "PaterJason/cmp-conjure", "Olical/conjure", "olimorris/codecompanion.nvim"}, event = "VeryLazy", main = "cmp"}
