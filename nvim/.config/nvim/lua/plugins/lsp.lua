...
local lsps = {"clojure_lsp", "nim_langserver", "lua_ls", "jsonls", "nil_ls", "clangd", "yamlls", "marksman", "html", "basedpyright", "ts_ls", "terraformls", "tailwindcss", "dockerls", "docker_compose_language_service", "bashls", "taplo", "sqlls"}
