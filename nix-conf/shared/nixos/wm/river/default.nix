...

{
  ...
  wayland.windowManager.river = {
    ...
    extraConfig = ''
      ...
      riverctl map normal Control+Super H resize horizontal -100
      riverctl map normal Control+Super J resize vertical +100
      riverctl map normal Control+Super K resize vertical -100
      riverctl map normal Control+Super L resize horizontal +100
